...
// GetAccount retrieves an account with its debug information. If not such contract at the given address, nil and proof of absence are returned
func (dacr *DebugApiContractReader) GetAccount(ctx context.Context, addr types.Address) (*types.SmartContract, mpt.Proof, error) {
